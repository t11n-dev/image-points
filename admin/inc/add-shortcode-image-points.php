...
function image_points_shortcode_func($atts){
	...
	$data_post = get_post_meta($idPost, 'image_points_content', true);
	...
	<div class="wrap_svl" id="body_drag_<?php echo esc_attr($idPost);?>">
		...
		$pins_image_hover = (isset($data_post['pins_image_hover']))?$data_post['pins_image_hover']:'';
		 ...
		 <div class="drag_element tips <?php echo ($pins_class)?esc_attr($pins_class):''?>" style="top:<?php echo esc_attr($point['top'])?>%;left:<?php echo esc_attr($point['left'])?>%;" <?php echo ($pins_id)?'id="'.esc_attr($pins_id).'"':''?>>
		 	<div class="point_style <?php echo ($pins_image_hover)?'has-hover':''?> image_points_tooltip_html" data-placement="<?php echo esc_attr($placement);?>" data-html="<?php echo esc_attr($view_html)?>">
		 		<?php if($linkpins):?><a href="<?php echo esc_attr($linkpins);?>" title="" <?php echo ($link_target)?'target="'.esc_attr($link_target).'"':'';?>><?php endif;?>
			 		...
			 		<?php endif;?>
			 		<img src="<?php echo esc_attr($pins_image)?>" class="pins_image <?php if(!$noTooltip):?>image_points_hastooltip<?php endif;?>" style="top:-<?php echo esc_attr($pins_more_option['custom_top'])?>px;left:-<?php echo esc_attr($pins_more_option['custom_left'])?>px" alt="<?php echo esc_attr($pinsalt);?>">
			 		<?php if($pins_image_hover):?><img src="<?php echo esc_attr($pins_image_hover)?>" class="pins_image_hover <?php if(!$noTooltip):?>image_points_hastooltip<?php endif;?>"  style="top:-<?php echo esc_attr($pins_more_option['custom_hover_top'])?>px;left:-<?php echo esc_attr($pins_more_option['custom_hover_left'])?>px" alt="<?php echo esc_attr($pinsalt);?>"><?php endif;?>
